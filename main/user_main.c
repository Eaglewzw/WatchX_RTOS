...
void WatchX_System_Init(void)
{
	...
	Device.stSize.iWidth = 128;          // 初始化显示尺寸大小 
    ...
    SGUI_Basic_DrawBitMap(&Device, &Logo_Icon_Area, &Logo_Icon_Offest, &LOT_WiFi_LOGO, SGUI_DRAW_NORMAL);//显示开机Logo图标
    OLED_RefreshScreen();  //刷新屏幕
